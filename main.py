...
if __name__ == '__main__':
    ...
    try:
        ...
        fetcher = DataFetcher(db_engine=engine)
        ...
        #Create threads for concurrent  data fetching, processing and inserting into database
        thread1 = threading.Thread(target=fetcher.fetch_process_insert, args=(disaster_apiurl, 'FemaWebDisasterDeclarations','DisasterDeclarations'))
        thread2 = threading.Thread(target=fetcher.fetch_process_insert, args=(disaster_declaration_summary_apiurl, 'DisasterDeclarationsSummaries','DisasterDeclarationsSummaries'))
